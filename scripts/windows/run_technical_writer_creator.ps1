...
$Script = Join-Path $Repo "factbook-assistant\citl_technical_writing_tutorial_creator.py"
$VenvPy = Join-Path $Repo ".venv\Scripts\python.exe"

Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  CITL Technical Writing and Tutorial Creator" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-OK "Repo   : $Repo"
